...
export const UserManagement = () => {
  ...
  const UserData = () => {
    ...
    fetch('https://custom2.mystagingserver.site/food-stadium/public/api/admin/user_listing',
      {
        method: 'GET',
        headers: {
  ...
  useEffect(() => {
    document.title = 'Food Stadium Admin | User Management';
    UserData()
                ...
                <div className="row mb-3 justify-content-between">
                  ...
                  <div className="col-md-6 mb-2">
                    <div className="addUser">
                      <CustomButton text="Add New User" variant='primaryButton' />
