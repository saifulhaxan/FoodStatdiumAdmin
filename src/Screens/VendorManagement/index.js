...
export const VendorManagement = () => {
  ...
  const UserData = () => {
    ...
    fetch('https://custom2.mystagingserver.site/food-stadium/public/api/admin/vendor_listing',
      {
        method: 'GET',
        headers: {
  ...
  useEffect(() => {
    document.title = 'Food Stadium Admin | Vendor Management';
    UserData()
                ...
                <div className="row mb-3 justify-content-between">
                  ...
                  <div className="col-md-6 mb-2">
                    <div className="addUser">
                      <CustomButton text="Add New Vendor" variant='primaryButton' />
                    ...
                    >
                      <tbody>
                        {currentItems.map((item, index) => (
                          <tr key={index}>
                            <td>{index + 1}</td>
                            <td><img src={base_url + item?.logo} className="avatarIcon"/></td>
