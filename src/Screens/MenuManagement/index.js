...
export const MenuManagement = () => {
  ...
  const bookData = () => {
    ...
    fetch('https://custom2.mystagingserver.site/food-stadium/public/api/menu_listing',
      {
        method: 'GET',
        headers: {
  ...
  useEffect(() => {
    document.title = 'Food Stadium Admin | Menu Management';
    bookData()
              ...
              <div className="dashCard">
                <div className="row mb-3 justify-content-between">
                  <div className="col-md-6 mb-2">
                    <h2 className="mainTitle">Menu Management</h2>
                  </div>
                  <div className="col-md-6 mb-2">
                            ...
                            <td>
                              <Dropdown className="tableDropdown">
                                ...
                                <Dropdown.Menu align="end" className="tableDropdownMenu">
                                  ...
                                  <Link to={`/menu-management/edit-menu/${item?.id}`} className="tableAction"><FontAwesomeIcon icon={faEdit} className="tableActionIcon" />Edit</Link>
