...
import { DietaryManagement } from "../Screens/DietaryManagement";
import { AddDietary } from "../Screens/DietaryManagement/AddDietary";
import { EditDietary } from "../Screens/DietaryManagement/EditDietary";
...
export default function AdminRouter() {
  return (
    <BrowserRouter basename="/FoodStadiumAdmin">
      <Routes>
        ...
        <Route path="/menu-management" element={<ProtectedRoutes Components={MenuManagement} />} />
        ...
        <Route path="/menu-management/edit-menu/:id" element={<ProtectedRoutes Components={EditMenu} />} />

        <Route path="/dietary-management" element={<ProtectedRoutes Components={DietaryManagement} />} />
        <Route path="/add-dietary" element={<ProtectedRoutes Components={AddDietary} />} />
        {/* <Route path="/dietary-management/dietary-details/:id" element={<ProtectedRoutes Components={dietaryDetails} />} /> */}
        <Route path="/dietary-management/edit-dietary/:id" element={<ProtectedRoutes Components={EditDietary} />} />
